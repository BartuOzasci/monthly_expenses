  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full py-2.5 sm:py-3 rounded-xl bg-gradient-to-r ${cat.gradientBg} ${cat.text} text-xs sm:text-sm font-semibold btn-press border ${cat.border} hover:brightness-125 transition-all`}
      >
        Detay Görüntüle
      </button>
    </div>
